<script>
  ...
  function convertImgWebp(){
    ...
    for (let index = 0; index < files.accepted.length; index++) {
      ...
      nameImgNew[index] = (files.accepted.name)
...
<main class="main-index">
  ...
  <Dropzone containerClasses="upload-box" on:drop={handleFilesSelect} accept={["image/*"]}>
    ...
    <p class="upload-box__subtitle">Drag and drop them here</p>
    <div>
      <span class="line"></span>
      <p>or</p>
      <span class="line"></span>
    </div>
    <button>Upload a Files</button>
    <p class="upload-box__count">12 files uploaded</p>
  ...
  <section class="imgs-box">
    ...
    <div class="imgs-box__nav">
      ...
      <button class="imgs-box__convert">Convert</button>
